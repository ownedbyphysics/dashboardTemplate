...
# Resellers
resellers = pd.read_csv(DATA_PATH.joinpath('brandPerResellerSunglasses.csv'), index_col = 0)
...
resellers = resellers[resellers['GENDER'] != 'Not Available']
resellers = resellers[resellers['GENDER'] != 'Children']
resellers['GENDER'] = resellers['GENDER'].replace({'Kids unisex':'Kids', 'Men':'Man'})
print(resellers['GENDER'].value_counts())

discount = pd.read_csv(DATA_PATH.joinpath('resellerDiscountSunglasses.csv'), index_col = 0)
...
layout = dbc.Container([
    dbc.Row([
     dbc.Col(html.H1("Sunglasses Case",
...
dbc.Col([
            ...
            dcc.Dropdown(id='brand-picker-sunglasses', options=brand_list,
...
dbc.Col([
            ...
            dcc.Dropdown(id='brand-picker2-sunglasses', options=brand_list,
      placeholder="Select a brand",
      ),
            ], 
            width={'size':3},  
...
dbc.Col([
            ...
            dcc.Graph(id='resellers-sunglasses')
            ], width={'size':6}),
...
dbc.Row([
    ...
    dbc.Col([
                ...
                dcc.Dropdown(id='reseller-picker-sunglasses', options=reseller_list,
    ...
    dbc.Col([
                ...
                dcc.Dropdown(id='reseller-picker2-sunglasses', options=reseller_list,
          placeholder="Select a reseller",
          ),
                ], 
                width={'size':3},  
    ...
    dbc.Col([
                html.H3('Reseller pick'),
                dcc.Graph(id='resellers-sunglasses-2')
                ], width={'size':6}),
...
dbc.Row([
    ...
    dbc.Col([
                ...
                dcc.Graph(id='discountGraphSunglasses')
                ], width={'size':6}),
...
@app.callback(Output('resellers-sunglasses', 'figure'),# Output('children', 'children')],
                [Input('brand-picker-sunglasses', 'value'), 
                Input('brand-picker2-sunglasses', 'value')])
...
@app.callback(Output('resellers-sunglasses-2', 'figure'),# Output('children', 'children')],
                [Input('reseller-picker-sunglasses', 'value'), 
                Input('reseller-picker2-sunglasses', 'value')])
...
@app.callback(Output('discountGraphSunglasses', 'figure'),
